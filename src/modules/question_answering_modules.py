...
class BertQuestionAnsweringModule(Module):
    ...
    def __init__(self, bert_model_name = 'bert-base-uncased', batch_first = True):
        super().__init__()
        self.bert_model = BertModel.from_pretrained(bert_model_name)
        self.bert_model_name = bert_model_name
        self.lstm = torch.nn.LSTM(self.__resolve_bert_model_size(), 300, bidirectional = True, dropout = 0, batch_first = batch_first)
